<html>
    ...
    <link href="<?php echo base_url('template_admin/') ?>vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
        href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">

    <!-- Custom styles for this template-->
    <link href="<?php echo base_url('template_admin/') ?>css/sb-admin-2.min.css" rel="stylesheet">
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">SBMPN</h6>
    </div>
    <div class="card-body">
            Periode
    </div>
        ...
        <div id="contact-field" style="display:none;">
            ...
            <label>Kabupaten</label><span id="phone-error" class="signup-error"></span>
            <div><input type="text" name="kabupaten" id="kabupaten" class="demoInputBox" /></div>
        </div>
